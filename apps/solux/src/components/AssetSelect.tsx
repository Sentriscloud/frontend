      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl overflow-hidden" style={{ background: '#0D1426', boxShadow: '0 2px 16px rgba(0,0,0,0.06)', border: '1px solid rgba(255,255,255,0.08)' }}>
          <div className="px-5 py-4" style={{ borderBottom: '1px solid #0F1A2E' }}>
            <h2 className="text-base font-bold" style={{ color: '#F1F5F9' }}>Select asset to send</h2>
          </div>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <p className="text-sm font-semibold" style={{ color: '#F1F5F9' }}>{srxDisplay}</p>
              <ChevronRight className="w-4 h-4" style={{ color: '#5A6A7A' }} />
            </div>
          </button>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <p className="text-sm font-semibold" style={{ color: '#F1F5F9' }}>{formatAmount(sntxBalance, sntxDecimals)}</p>
              <ChevronRight className="w-4 h-4" style={{ color: '#5A6A7A' }} />
            </div>
          </button>
        </div>
