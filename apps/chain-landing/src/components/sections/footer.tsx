...
const COLUMNS = [
  ...
  },
  {
    heading: "Build",
    links: [
      { label: "API Docs",   href: SITE.api },
      { label: "RPC",        href: SITE.rpc },
      { label: "GitHub",     href: SITE.github },
      { label: "Releases",   href: "https://github.com/sentrix-labs/sentrix/releases" },
    ],
  },
  {
    heading: "Community",
    links: [
      { label: "Telegram", href: "https://t.me/SentrixCommunity" },
      { label: "Twitter",  href: "https://x.com/SentrixChain" },
    ],
  },
];
  ...
  return (
    <footer className="border-t border-[var(--brd)] bg-[var(--sf)]">
      ...
      <div className="px-6 md:px-[60px] pt-12 pb-8 flex items-center justify-between gap-6 flex-wrap">
        <div className="flex items-center gap-3 text-[var(--gold-dk)]">
          <SentrixLogo size={28} />
          <span className="font-serif text-base font-light tracking-[.3em] uppercase">
            SENTRI<span className="text-[var(--gold-d)]">X</span>
          </span>
        </div>
